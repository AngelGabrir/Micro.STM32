    ...
    /* USER CODE END WHILE */
	  Server_Start();
	  	/*	if (HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_13) == 1) {
	  			//Servo_MoveToAngle(&servo, 180, 200);
	  			stepper_step_angle(500, 0, 13);
	  			max_clear();
	  			write_char(127, 1);
	  		} else if (HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_5) == 1) {
	  			//Servo_MoveToAngle(&servo, 0, 200);
	  			//stepper_step_angle(90, 0, 13);
	  			//Send_cmd(0x0F, 0x01, 0x01);
